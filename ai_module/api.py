...
class AnswerRequest(BaseModel):
    student_answer: str
    correct_answer: str
    role: str = "General"      # Default to General if not provided
    company: str = "General"   # Default to General if not provided
...
def evaluate(req: AnswerRequest):
    try:
        # Pass role and company to your evaluation logic
